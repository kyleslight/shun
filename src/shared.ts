...
export type PluginPermission = { id: 'workspace.git.read' | 'workspace.git.write' | 'workspace.read' | 'workspace.reveal' | 'conversation.context' | 'conversation.ui'; reason: string }
export type PluginViewLocation = 'workspace.right' | 'workspace.main'
export type PluginViewManifest = { id: string; title: string; location: PluginViewLocation; entry: string }
export type PluginConversationAction = { id: string; title: string; placement: 'message' | 'composer'; command: string }
export type PluginSkillContribution = { path: string }
export type PluginContributions = { views?: PluginViewManifest[]; conversationActions?: PluginConversationAction[]; skills?: PluginSkillContribution[] }
...
export type PluginViewContribution = { pluginId: string; viewId: string; title: string; location: PluginViewLocation; url: string; icon: PluginManifest['icon']; permissions: string[]; accessToken: string; experimental?: boolean }
export type PluginPackageEvent = { manifest: PluginManifest; enabled: boolean; permissions: string[] }
export type PluginWorkspaceChange = { subscriptionId: string; paths: string[]; overflow: boolean }
